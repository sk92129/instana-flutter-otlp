...
import 'package:instanaclient/settings.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void setupInstana() async {
    ...
    try {
      bool ret = await InstanaAgent.setup(key: KEY_INSTANA_AGENT, 
          reportingUrl: URL_REPORTING, options: options);
        if (!ret) {
          // Error handling here
          if (kDebugMode) {
      ...
      if (kDebugMode) {
        print("InstanaAgent setup failed: $e");
      }
    }
